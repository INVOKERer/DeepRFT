...
def create_lmdb_for_SIDD():
    folder_path = '/home/mxt/106-48t/personal_data/mxt/Datasets/SIDD/train/input_crops'
    lmdb_path = '/home/mxt/106-48t/personal_data/mxt/Datasets/SIDD/train/input_crops.lmdb'

    img_path_list, keys = prepare_keys(folder_path, 'PNG')
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    folder_path = '/home/mxt/106-48t/personal_data/mxt/Datasets/SIDD/train/gt_crops'
    lmdb_path = '/home/mxt/106-48t/personal_data/mxt/Datasets/SIDD/train/gt_crops.lmdb'
