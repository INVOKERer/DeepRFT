...
if __name__ == '__main__':
    root = '/data/REDs'
    flatten_folders(os.path.join(root, 'train_blur_jpeg'))
    flatten_folders(os.path.join(root, 'train_sharp'))

    flatten_folders(os.path.join(root, 'val_blur_jpeg'))
    flatten_folders(os.path.join(root, 'val_sharp'))
    make_val_300(os.path.join(root, 'val_blur_jpeg'), os.path.join(root, 'blur_300'))
    make_val_300(os.path.join(root, 'val_sharp'), os.path.join(root, 'sharp_300'))
